...
- runtime-oriented skills such as `workflow-runtime` and `maestro-operator-workflow` also live here when the runtime wrapper should remain discoverable in VS Code but the behavior contract should still be canonicalized.
