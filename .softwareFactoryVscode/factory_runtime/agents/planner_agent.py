...
_SYSTEM_PROMPT = """You are the softwareFactoryVscode PlannerAgent.
...
class PlannerAgent:
    """Creates execution plans for the package runtime using premium models."""
    ...
    async def run(
        ...
        try:
            ...
            final_content = str(self._messages[-1].get("content", ""))
