"""RouterAgent — complexity scoring and model tier assignment for the package runtime.
...
This module selects execution tiers before coding begins.
"""
...
class RouterAgent:
    ...
    async def route(
        ...
        if changed_files:
            hinted_files.extend(changed_files)
