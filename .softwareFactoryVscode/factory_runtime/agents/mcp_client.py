...
Used by all package agents (router, coder, orchestrator) to access:
...
This client provides a merged view of runtime MCP tools.
"""
...
class MCPMultiClient:
    ...
    def get_all_tool_definitions(self) -> list[dict[str, Any]]:
        """Return OpenAI-compatible function tool definitions for all MCP tools."""
        return [
            {
                "type": "function",
                "function": {
