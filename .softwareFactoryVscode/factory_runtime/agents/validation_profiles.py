...
_PROFILE_MAP = {
    "factory": {
        ...
        "type_only": [],
        "doc_only": ["python scripts/check_docs_accuracy.py"],
    },
    "host": {
        "full": ["python scripts/project_runtime_validate.py --target ."],
        "test_only": ["python scripts/project_runtime_validate.py --target ."],
        "type_only": [],
