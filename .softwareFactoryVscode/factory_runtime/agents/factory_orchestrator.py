"""FactoryOrchestrator — top-level package agent pipeline.
...
Typical usage (programmatic):
    orchestrator = FactoryOrchestrator(server_urls={...})
    result = await orchestrator.run_issue(42, "YOUR_ORG/YOUR_REPO", "Fix bug", "Body...")
    print(result.pr_url)

This module coordinates routing, planning, coding, PR creation, and memory.
"""
...
class OrchestratorResult:
    """End-to-end result of running the package runtime on one issue."""
...
class FactoryOrchestrator:
    ...
    async def _create_pr(
        ...
        body = (
            ...
            f"Generated by softwareFactoryVscode (run `{run_id}`).\n\n"
