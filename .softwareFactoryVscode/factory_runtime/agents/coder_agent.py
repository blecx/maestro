"""CoderAgent — single persistent thread coder for the factory runtime.
...
This implementation is retained as a package-owned runtime orchestration component.
"""
...
_SYSTEM_PROMPT = """\
You are the softwareFactoryVscode CoderAgent — an expert software engineer implementing scoped changes.
...
```json
{
  ...
  "file_edits": [
    ...
    "validation_commands": ["pytest tests/ factory_runtime/tests", "python scripts/check_neutrality.py"]
}
```
