...
DEFAULT_TARGETS = {
    "factory": "compose/docker-compose.factory.yml",
    "context7": "compose/docker-compose.context7.yml",
    "bash_gateway": "compose/docker-compose.mcp-bash-gateway.yml",
    "repo_fundamentals": "compose/docker-compose.repo-fundamentals.yml",
    "devops_mcp": "compose/docker-compose.mcp-devops.yml",
}
...
mcp = FastMCP("softwareFactoryVscode Docker Compose MCP", json_response=True)
