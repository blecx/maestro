...
class AgentBus:
    """SQLite-backed context bus for package agent task runs."""
    ...
    # ------------------------------------------------------------------
    # Context packet (the key runtime primitive)
    # ------------------------------------------------------------------

    def read_context_packet(self, run_id: str) -> dict[str, Any]:
        """Return all run data in one call - the core runtime primitive.
