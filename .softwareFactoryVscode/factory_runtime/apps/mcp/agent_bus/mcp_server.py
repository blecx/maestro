...
This server provides the package-owned task context bus.
"""
...
def bus_read_context_packet(run_id: str) -> dict[str, Any]:
    ...
    This is the core runtime context primitive. Any agent calls this once
...
def bus_write_snapshot(
    ...
    Args:
        run_id: Run UUID.
        filepath: Workspace-relative file path (e.g. 'src/services/x.py').
