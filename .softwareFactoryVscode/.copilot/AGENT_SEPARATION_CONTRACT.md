...
This document acts as a repository-local checklist enforcing what each agent, skill, and script class may and may not own. Its goal is to maintain architectural clarity and prevent logic duplication across the software factory ecosystem.
