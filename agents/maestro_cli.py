...
Usage:
    python -m agents.maestro_cli --issue 42 --repo blecx/maestro

Or import and call directly:
    python agents/maestro_cli.py --issue 42 --repo blecx/maestro
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        "-r",
        required=True,
        help="Repository in owner/name format (e.g. blecx/maestro)",
    )
    parser.add_argument(
        "--title",
        default="",
